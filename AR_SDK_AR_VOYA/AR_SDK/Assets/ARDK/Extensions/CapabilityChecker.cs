  ...
  public class CapabilityChecker: UnityLifecycleDriver
  {
    ...
    private void Succeed()
    {
      ARLog._Debug("Capability check succeeded ");
            ErrrorMessage.text = "Capability check succeeded ";
          HasSucceeded = true;
      Success.Invoke();
    }

    public void Fail(FailureType type, string message)
    {
          ...
          switch (hardwareCapability)
          {
            case ARHardwareCapability.NotCapable:
              ...
              (
                ...
                ErrrorMessage.text =  "ARDK: Device not capable of world tracking!"
              );
            ...
            case ARHardwareCapability.CheckFailedWithError:
              ...
              (
                FailureType.Error,
                ErrrorMessage.text = "ARDK: Unable to check for compatibility due to some error! Check logs for ARCore issues."
              );
            ...
            case ARHardwareCapability.CheckFailedWithTimeout:
              ...
              (
                FailureType.Timeout,
               ErrrorMessage.text = "ARDK: Unable to check for compatibility due to network timeout! Make sure you are connected to the Internet and try again later!"
              );
