...
namespace Niantic.ARDK.Extensions.Meshing
{
  ...
  public class ARMeshManager: ARSessionListener
  {
    ...
    protected override void ListenToSession()
    {
      ...
      _arSession.Mesh.MeshBlocksUpdated += OnMeshUpdated;
    ...
    public void SetUseInvisibleMaterial(bool useInvisible)
    {
      ...
      _generator?.SetUseInvisibleMaterial(useInvisible);
        ...
        /// ////////////////////////////////////////////// INVOLKE HERE
        /// </summary>
    public void SetUseInvisibleMateriall()
        {
            _IsVisualization = !_IsVisualization;
            Debug.Log(_IsVisualization);
            _generator?.SetUseInvisibleMaterial(_IsVisualization);
            _toggleDepthButtonText.text = _IsVisualization ? "Show Mesh" : "Hide Mesh";
